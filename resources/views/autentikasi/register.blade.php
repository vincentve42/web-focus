    ...
    <body>
        <div class="lg:justify-self-end lg:mr-40 lg:mt-40 lg:w-96 lg:h-128 text-2xl justify-self-center lg:border lg:border-indigo-500 rounded-2xl">
            <form action="{{ route('Register') }}" method="post">
                ...
                <div class="flex justify-start lg:justify-self-start justify-self-center lg:ml-10 lg:mt-10 lg:pt-5  border-b border-black text-xl pt-10">
                    <div>
                ...
                <div class="flex justify-start lg:justify-self-start justify-self-center lg:ml-10 lg:mt-1 lg:pt-3  border-b border-black text-xl pt-5">
                    <div>
                ...
                <div class="flex justify-start lg:justify-self-start justify-self-center lg:ml-10  lg:pt-3 pt-5  border-b border-black text-xl">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 text-gray-300">
             ...
             <div class="justify-self-center lg:justify-self-start pt-10">
                <button class="lg:ml-10 lg:mt-10 lg:p-2 p-3 border border-indigo-500 rounded-3xl text-xl lg:w-32 w-48">Register</button>
             </div>
            @if ($errors->any())
