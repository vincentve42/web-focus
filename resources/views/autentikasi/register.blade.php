    ...
    <body>
        <div class="sm:justify-self-end sm:mr-40 sm:mt-40 sm:w-96 sm:h-128 text-2xl justify-self-center sm:border sm:border-indigo-500 rounded-2xl">
            <form action="{{ route('Register') }}" method="post">
                ...
                <div class="flex justify-start sm:justify-self-start justify-self-center sm:ml-10 sm:mt-1 sm:pt-3  border-b border-black text-xl pt-5">
                    <div>
             ...
             <div class="justify-self-center sm:justify-self-start pt-10">
                <button class="sm:ml-10 sm:mt-10 sm:p-2 p-3 border border-indigo-500 rounded-3xl text-xl sm:w-32 w-48">Register</button>
             </div>
            @if ($errors->any())
<div class="pt-5 justify-self-center text-xs sm:text-xs sm:ml-5 sm:justify-self-start text-red-500">
<ul>
...
@endif
            ...
            <a href="{{ route('LoginUi') }}"><p class="text-blue-500 sm:ml-10 justify-self-center sm:justify-self-start sm:text-xl pt-5 text-xl/3">Have An Account?</p></a>
        </div>
    </body>
</html>