...
<div class="lg:ml-80 shadow-xl h-230 sm:h-200 bg-white lg:mt-5 lg:w-300 mt-5 lg:mr-5 lg:ml-5">
   ...
   <table class=" justify-start ml-2 lg:ml-3">
      ...
      <tr class="border-b border-gray-300">
         ...
         <td class="p-1 text-center lg:text-base text-xs">
            <a href="{{ route('ViewImage', ['img_path' => $data_keuangan->image]) }}">View Image</a>
         </td>
