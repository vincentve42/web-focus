...
<button @click="mobile = !mobile" data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg lg:hidden md:block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<div class="lg:ml-85 shadow-xl h-200 bg-white lg:mt-5 lg:w-300 mt-5 lg:mr-5  md:w-full">
   ...
   <table class=" justify-start ml-2 lg:ml-3">
      ...
      <tr class="border-b border-gray-300">
         <td class="p-1 text-center lg:text-base text-xs">{{ $single_data->keterangan_1 }}</td>
         <td class="p-1 text-center lg:text-base text-xs">{{ $single_data->keterangan_2 }}</td>
         <td class="p-1 text-center lg:text-base text-xs">{{ $single_data->debit }}</td>
         <td class="p-1 text-center lg:text-base text-xs">{{ $single_data->kredit }}</td>
...
<td><a href="{{ route('EditLaporanKeuanganUi', ['id' => $single_data->id]) }}">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="lg:size-10 text-green-500 size-6 p-1">
