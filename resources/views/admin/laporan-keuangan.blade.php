...
<button @click="mobile = !mobile" data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden md:block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<div class="sm:ml-80 shadow-xl h-200 bg-white sm:mt-5 sm:w-300 mt-5 sm:mr-5 md:ml-10 md:w-full">
   ...
   <table class=" justify-start ml-2 sm:ml-3">
      ...
      @foreach ($data_keuangan as $single_data )
      <tr class="border-b border-gray-300">
         <td class="p-1 text-center sm:text-base text-xs">{{ $single_data->keterangan_1 }}</td>
         <td class="p-1 text-center sm:text-base text-xs">{{ $single_data->keterangan_2 }}</td>
         <td class="p-1 text-center sm:text-base text-xs">{{ $single_data->debit }}</td>
         <td class="p-1 text-center sm:text-base text-xs">{{ $single_data->kredit }}</td>
         ...
         <td class="p-1"><a href="{{ route('DeleteLaporanKeuangan', ['id' => $single_data->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sm:size-10 size-6 text-red-500 p-1">
  <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg></a>
</td>
<td><a href="{{ route('EditLaporanKeuanganUi', ['id' => $single_data->id]) }}">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sm:size-10 text-green-500 size-6 p-1">
...
<div class="sm:ml-20 shadow-xl bg-white sm:mt-5 sm:mr-20 mt-5 mr-5 ml-5 sm:w-200">
   <h1 class="text-xl font-bold p-5">Tambah Laporan</h1>
